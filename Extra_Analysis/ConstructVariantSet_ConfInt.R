### Identifying variants labeled 'pathogenic/neutral' in a prior ClinVar version 
### but categorized as 'Conflicting interpretations of pathogenicity' in the main version.
...
### Mapping the variants' chromosome coordinates  to proteins and positions using our Map2Prot pipeline
### (https://github.com/CompGenomeLab/PHACTboost/tree/main/Map2Prot)
### Resulting data: "ConfInt_Variants_Mapped.csv"
